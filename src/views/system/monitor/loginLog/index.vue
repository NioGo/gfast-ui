  ...
  <div class="system-dic-container">
    <el-card shadow="hover">
      ...
      <el-table border :data="tableData.data" style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column resizable label="编号" align="center" prop="infoId" />
        <el-table-column resizable label="登录名称" align="center" prop="loginName" />
        <el-table-column resizable label="登录地址" align="center" prop="ipaddr" width="130" :show-overflow-tooltip="true" />
        <el-table-column resizable label="登录地点" align="center" prop="loginLocation" :show-overflow-tooltip="true" />
        <el-table-column resizable label="浏览器" align="center" prop="browser" />
        <el-table-column resizable label="操作系统" align="center" prop="os" />
        <el-table-column resizable label="登录状态" align="center" prop="status" :formatter="statusFormat" />
        <el-table-column resizable label="操作信息" align="center" prop="msg" />
        <el-table-column resizable label="登录日期" align="center" prop="loginTime" width="180" />
        <el-table-column resizable label="登录模块" alian="center" prop="module"></el-table-column>
      </el-table>
      <pagination
